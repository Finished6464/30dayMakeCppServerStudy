...
Connection::Connection(EventLoop *loop, int fd, std::function<void()> callback)
: loop_(loop)
, fd_(fd)
, callback_(callback)
{
...
void Server::NewConnection(int fd)
{
    ...
    // }
    Connection *conn = new Connection(loop_, fd, std::bind(&Server::DeleteConnection, this, fd));
